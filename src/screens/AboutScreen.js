  ...
  return (
    <ScrollView style={s.screen} contentContainerStyle={{ padding: spacing.xl, alignItems: 'center' }}>
      <View style={{ width: 100, height: 100, backgroundColor: colors.blue + '15', borderRadius: 50, alignItems: 'center', justifyContent: 'center', marginBottom: 20 }}>
        <Feather name="smartphone" size={40} color={colors.blue} />
      </View>
      ...
      <View style={[s.section, { width: '100%', padding: 20 }]}>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 15 }}>
          <Feather name="tool" size={16} color={colors.blue} />
          <Text style={{ color: colors.blue, fontWeight: '800', fontSize: 16, textAlign: 'center', marginLeft: 8 }}>الإشراف والدعم الفني</Text>
        </View>
      ...
      <View style={[s.section, { width: '100%', padding: 20 }]}>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 15 }}>
          <Feather name="code" size={16} color={colors.cyan} />
          <Text style={{ color: colors.cyan, fontWeight: '800', fontSize: 16, textAlign: 'center', marginLeft: 8 }}>التطوير والتصميم</Text>
        </View>
      ...
      <Btn label="عودة للرئيسية" icon="arrow-right" variant="outline" style={{ marginTop: 20, width: '100%' }} onPress={() => navigation.goBack()} />
    </ScrollView>
  );
}
